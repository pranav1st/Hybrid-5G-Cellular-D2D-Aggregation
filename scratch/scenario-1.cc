...
main (int argc, char *argv[])
{
  ...
  CcBwpCreator::SimpleOperationBandConf bandConf1 (centralFrequencyBand1, bandwidthBand1, numCcPerBand, BandwidthPartInfo::UMa);
  CcBwpCreator::SimpleOperationBandConf bandConf2 (centralFrequencyBand2, bandwidthBand2, numCcPerBand, BandwidthPartInfo::UMa);
  ...
  flowmonHelper.SerializeToXmlFile("relayservice-flowmon.xml", true, true);
  flowOut.close();
